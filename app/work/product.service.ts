...
private _itechUrl= '/tech.json';
    ...
    getDetails() : IProfessional[] {
      ...
      ["Involved in application development for various office365 web applications using ASP.Net MVC / C# / SQL Server / AngularJS / AJAX / HTML / CSS",
